...
Canos.prototype.desenhar = function (ctx) {
  ctx.save();
...
Canos.prototype.desenharColisaoComPonto = function (ctx) {
  ctx.save();
...
Canos.prototype.desenharImg = function (ctx, img) {
  ctx.save();
...
Canos.prototype.mover = function (dt) {
...
Canos.prototype.colidiuComPonto = function (alvo) {
...
Canos.prototype.colidiuComCanos = function (alvo) {
 return this.colideTop(alvo) + this.colideBot(alvo);
};

Canos.prototype.colideTop = function (alvo) {
...
Canos.prototype.colideBot = function (alvo) {
